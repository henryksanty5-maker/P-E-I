...
const GlobalCSS = () => (
  <style>
    {`
      ...
      /* IMPRESSÃO FORÇADA (ANTI-BUG DO CHROME) */
      @media print {
        @page { margin: 15mm; }
        ...
        /* A ORDEM MILITAR: Tudo o que tem a classe 'print-block' é forçado a empilhar */
        .print-block, .print-input-group {
          display: block !important;
          width: 100% !important;
...
// 4B. NOVO FORMULÁRIO: PAEE (BLINDADO)
